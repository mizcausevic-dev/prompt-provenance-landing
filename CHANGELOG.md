...
### Released
- Shipped **prompt-provenance-landing** as a public artifact for teams dealing with enterprise software operations.
...
### Shipped
- Cut the first coherent internal version of **prompt-provenance-landing** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Landing site for the Prompt Provenance spec. Live at prompts.kineticgain.com.
